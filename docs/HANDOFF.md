...
| `hardware/SRFM_PCB/` | V1.1 board design (2026-09-11): Gerbers, netlist, EasyEDA project. D7–D10 are the right way round in V1.1; the V1 files (source of the channel map and the D7–D10 finding) are in git history at e6ce3fd |
